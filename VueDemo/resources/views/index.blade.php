            ...
            <div class="col-md-9 col-xl-9 m-auto">
              <ul class="tab-heading my-4">
                ...
                <div class="row mt-5 text-center">
                  ...
                  <div class="col-md-4 p-0 ms-3  pt-3 " >
                    <div class="card   border-white wave" style="width: auto;" >
                      <div class="m-3 sh-l card-sub shadow-lg p-3 bg-white text-end " style="border-radius: 15px;" >
                        <img src="img/STM32F103C8T6/stm32f103c8t6.jpg" class="card-img-top mb-3" height="200px" width="50px" alt="..."> 

                        <h5 class="card-title m-0">STM32F103C8T6</h5>
                        <p class="text-end m-0" >
                          200,000 <small>تومان</small>
                        </p>
                        <div class="text-start ">
                        </div>
                        <div class=" text-center mt-2  mb-2" >
                          <a href="product.html"  class="btn  rounded-pill kb text-white px-4" style="
                          background-image: radial-gradient(ellipse, #e5b04fc0 20%, #e0a73b 100%); ">
                             افزودن به سبد خرید ->
                            
                            </a>
                            <div>
                              <a class="mt-4" style="font-size: 12px; color:#ce8f5a; text-decoration: underline;" href="">اضافه به لیست علاقه مندی ها</a>
                            </div>
                        </div>
            ...
            <div class="col-md-9 col-xl-9 m-auto">
              <ul class="tab-heading my-4">
                ...
                <div class="row mt-5 text-center">
                  ...
                  <div class="col-md-4 p-0 ms-3  pt-3 " >
                    <div class="card   border-white  wave" style="width: auto;" >
                      <div class="m-3 sh-l p-3 bg-white text-end " style="border-radius: 15px;" >
                        <img src="img/arduino/arduino-uno-r3-development-board.png" class="card-img-top mb-3" height="200px" width="50px" alt="..."> 


                      <h5 class="card-title"> برد آردوینو Arduino Uno R3 با تراشه R3 اورجینال</h5>
                      <p class="mb-0 card-text text-danger">
                        <del>180,000 تومان</del>
                      </p>
                      <p class="card-text">
                        140,000 تومان
                      </p>

            ...
            <nav>
                ...
                <div class="navbar navbar-expand-lg p-0 navbar-light">
                    <div class="container">
                        ...
                        <div class="flux me-auto navbar-brand  ps-5" style="">روبوفروشآنلاین </div>
                        ...
                        <div class="col-md-3  customer-item " style="padding-bottom: 500px !important;">
                            ...
                            <nav class="small " id="toc">
                                <ul class="list-unstyled fs-5 p-0">
                                    ...
                                    <li class="customer-item-h my-2 py-2">
                                        <a onclick="openCity(event, 'edit-info')" class="text-light pe-3 d-inline-flex align-items-center collapsed" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#contents-collapse" aria-controls="contents-collapse">لیست سفارشات </a>
                                    </li>

                                    <li class="customer-item-h my-2 py-2">
                                        <a onclick="openCity(event, 'edit-info')" class="text-light pe-3 d-inline-flex align-items-center collapsed" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#contents-collapse" aria-controls="contents-collapse"> علاقه مندی ها</a>
                                    </li>
